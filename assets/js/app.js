...
$("body").prepend('<div class=text-white style=position:fixed;top:0;bottom:0;width:100%;z-index:99999999;padding-top:12%;background-color:rgba(87,87,87,.95);" id="cover-page"><div id="cover-page-con" class="container text-center"style="opacity:100%;"><img alt="Jose Yepez"class="img-fluid rounded-circle"src="/images/mylogo.png"><h1>Jose Yepez</h1><p class=lead>...inspired innovative technology leader & follower.<p class=lead style=font-size:80%><i class="fa-1x fa-cog fa-spin fas"></i> we are preparing your experiance now...</div></div>');

const parentPageID = 141;
...
function getContent() {
    $.ajax({
        method: 'GET',
        url: 'https://me.yepezdesigns.com/wp-json/wp/v2/pages/?parent=' + parentPageID + '&order=asc&orderby=menu_order',
        dataType: 'json',
